...
$( document ).ready(function() {
    ...
    $.ajax({
    	type: 'Get',
        // url: 'http://cvyhj3a27:8181/penetration/getchart?cType=URO',
    	
    	
        //url: 'http://localhost:8181/webreport/getchart?cType=LHP',
        url: 'http://localhost:8181/penetration/getchart?cType=URO',
        dataType: "json",
...
/******************************************************************************************************************************************************************/
        	  ...
        	  var ctx = document.getElementById("mycanvasURO").getContext("2d");
