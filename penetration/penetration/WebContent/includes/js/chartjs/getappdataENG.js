...
$( document ).ready(function() {
    ...
    $.ajax({
    	type: 'Get',
        // url: 'http://cvyhj3a27:8181/penetration/getchart?cType=ENG',
    	
    	
        //url: 'http://localhost:8181/webreport/getchart?cType=LHP',
        url: 'http://localhost:8181/penetration/getchart?cType=ENG',
        dataType: "json",
...
/******************************************************************************************************************************************************************/
        	  ...
        	  var ctx = document.getElementById("mycanvasENG").getContext("2d");
