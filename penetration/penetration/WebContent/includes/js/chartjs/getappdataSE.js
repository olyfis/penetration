...
$( document ).ready(function() {
    ...
    $.ajax({
    	type: 'Get',
        // url: 'http://cvyhj3a27:8181/penetration/getchart?cType=SE',
    	
    	
        //url: 'http://localhost:8181/webreport/getchart?cType=LHP',
        url: 'http://localhost:8181/penetration/getchart?cType=SE',
        dataType: "json",
...
/******************************************************************************************************************************************************************/
        	  ...
        	  var ctx = document.getElementById("mycanvasSE").getContext("2d");
