...
$( document ).ready(function() {
    ...
    $.ajax({
    	type: 'Get',
        // url: 'http://cvyhj3a27:8181/penetration/getchart?cType=ENT',
        ...
        success: function(data) {
        	...
        	//$("#jsonArr").val(JSON.stringify(data));
        	//sessionStorage.setItem("ja", data)
        	//console.log(data);
        	var month_arr = [];
        	var sales_arr = [];
        	var pen_arr = [];
...
/******************************************************************************************************************************************************************/
        	  ...
        	  var ctx = document.getElementById("mycanvasENT").getContext("2d");
